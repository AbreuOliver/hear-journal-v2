...
{#if engagementModalOpen}
  ...
  <button
    ...
    class="fixed inset-0 z-[60] bg-white/5 backdrop-blur-[4px]"
    on:click={toggleEngagementModal}
  ...
  <div
    ...
    class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[70]
           w-[92vw] max-w-md rounded-3xl shadow-2xl border border-white/10
           bg-neutral-950/90 backdrop-blur-xl text-white p-6"
  >
    <!-- Header row -->
    ...
    <!-- Footer note -->
    <!-- <div class="mt-4 rounded-2xl p-3 bg-white/5 border border-white/10">
